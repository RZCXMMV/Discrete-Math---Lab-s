...
def generate_bicondicional(n):
    if n == 2:
        MostrarImagen("../resources/bicondicional_2.png")
    elif n == 3:
        MostrarImagen("../resources/bicondicional_3.png")
    elif n == 4:
        MostrarImagen("../resources/bicondicional_4.png")
    else:
